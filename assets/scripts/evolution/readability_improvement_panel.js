...
var docElementBody = document.querySelector('html'),
  ...
  console.log(docElementBody);
  console.log(computedBody);
  console.log(computedBkgColor);
  console.log(toggleInvertColors);
  console.log(toggleGrayscale);
  console.log(toggleLargerFont);
  console.log(readabilityToggleContainer);
...
// first check if the element exists, and if it does, then assign the listener
  console.log("readabilityToggleContainer:", readabilityToggleContainer);
